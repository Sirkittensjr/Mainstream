      ...
      {open && (
        <Portal>
          <div className="fixed inset-0 z-[60] flex items-end justify-center bg-black/70 p-0 backdrop-blur-sm sm:items-center sm:p-6">
            <div className="card max-h-[88dvh] w-full max-w-md animate-fade-up overflow-y-auto rounded-b-none p-6 sm:rounded-3xl">
              <div className="mb-4 flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-white/50">
                    Reports go to the FayTarra moderation team. We never tell
                    the other person who reported them.
                  </p>
                </div>
                <button
                  type="button"
