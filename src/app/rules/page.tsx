...
export const metadata: Metadata = {
  ...
  description: 'What is and is not allowed on FayTarra, and how to report it.',
};
...
const RULES = [
  ...
  {
    title: 'No spam',
    body: 'No mass identical posts, no engagement farming rings, no automated liking. FayTarra points come from real participation.',
  },
  {
    title: 'No scams',
  ...
  {
    title: 'No rating manipulation',
    body: 'No fake accounts, no rating rings, no trading ratings, no paying for ratings. Ratings are weighted and audited, weight is revoked from accounts that game them, and buying exposure will never buy you a better rating.',
  },
  {
  ...
  return (
    <div className="min-h-dvh">
      ...
      <main className="mx-auto max-w-3xl px-5 pb-24">
        <ShieldIcon width={30} height={30} className="text-fay" />
        ...
        <p className="mt-5 max-w-2xl text-lg text-white/55">
          FayTarra is built for people trying to get somewhere. That only works if the place feels
        ...
        <section className="card mt-8 p-6">
          ...
          <p className="mt-4 leading-relaxed text-white/55">
            You can delete your own posts at any time from the post page. Every post and profile
            also has a <strong className="text-white">Rate</strong> button — one rating per person,
            changeable whenever you like.
          </p>
        </section>
        ...
        <section className="card mt-4 p-6">
          ...
          <ul className="mt-3 space-y-2 leading-relaxed text-white/55">
            <li>· FayTarra is not intended for anyone under 13, and we do not market it to children.</li>
            ...
            <li>· Posts and images are served by FayTarra itself, not third party trackers.</li>
